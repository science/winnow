...
- **Demo scorer is deterministic by design** (fnv1a of videoId). Nonlive e2e asserts exact tier placements (`abc123DEF45` → top, `live456GHI78` → winnowed). Changing its math means recomputing those expectations.
